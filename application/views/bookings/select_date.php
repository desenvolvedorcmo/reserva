...
<table>
	<tr>
		...
		<td valign="middle">
			<img style="cursor:pointer" align="top" src="<?= base_url('assets/images/ui/cal_day.png') ?>" width="16" height="16" title="Escolha a data" onclick="displayDatePicker('chosen_date', false);" />
		</td>
		<td> &nbsp; <input type="submit" value=" Carregar " /></td>
	</tr>
</table>
</form>
